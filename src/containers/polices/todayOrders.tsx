    ...
    const cards = [
        {
            ...
            text: "Комбинированного страхования от несчастных случаев",
            link: '/admin/new/create?tariff=1'
        },
        {
            title: "Страхование от несчастных случаев и потери дохода",
            text: 'Комбинированного страхования от несчастных случаев и потери дохода',
            link: '/admin/new/create?tariff=2'
        }
    ];
